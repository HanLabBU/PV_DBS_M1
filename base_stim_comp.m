...
for f_stim=stims'
    nexttile;
    violin([data_bystim.(f_stim{1}).neuron_base_Vm', data_bystim.(f_stim{1}).neuron_stim_Vm'], 'xlabel', {'Base', 'Stim'});
    hold on;
...
sgtitle('Average baseline and stim Vm');
...
for f_stim=stims'
    nexttile;
    violin([data_bystim.(f_stim{1}).neuron_base_srate', data_bystim.(f_stim{1}).neuron_stim_srate'], 'xlabel', {'Base', 'Stim'});
    hold on;
...
sgtitle('Baseline and stim firing rate');
