...
classdef Multi_func
    properties (Constant)
        ...
        % For Windows
        save_plot = ['C:\Users\fabri\BOSTON UNIVERSITY Dropbox\Pierre Fabris\Pierre PV DBS Project Dropbox\Materials\Plots\'];
        ...
        % Specify the colors for the points of each mouse
        mouse_color = struct( ...
            'm109567', [0.00 0.45 0.74], ...
            'm109557', [0.85 0.33 0.10], ...
            'm109558', [0.49 0.18 0.56], ...
            'm23072', [0.47 0.67 0.19], ...
            'm611284', [0.30 0.75 0.93], ...
            'm96334', [0.64 0.08 0.18], ...
            'm31556eartag', [0.73 0.26 0.51], ...
            'm31556noeartag', [0.18 0.55 0.34], ...
            'm50373', [0.87 0.49 0.00], ...
            'm50464', [0.00 0.75 0.65], ...
            'm617100', [0.55 0.27 0.07], ...
            'm81631', [0.95 0.00 0.95] ...
            );
    end
